...
class UserProfile(models.Model):
    ...
    payout_upi_id = models.CharField(max_length=100, blank=True, null=True)
    payout_bank_details = models.JSONField(blank=True, null=True, help_name="Store bank details as JSON")
